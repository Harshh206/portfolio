    ...
    <section id="contact" className="py-20 bg-slate-900 text-white">
      <div className="max-w-4xl mx-auto px-6 text-center">
        ...
        <p className="mb-8 text-slate-400 max-w-2xl mx-auto">
          I'm actively looking for entry-level opportunities where I can contribute 
          and grow as a developer. Feel free to reach out if you'd like to discuss 
        ...
        <div className="mt-12 pt-8 border-t border-slate-800">
          <p className="text-slate-500">
            © 2024 Priya Sharma. Open to opportunities.
          </p>
        </div>
      </div>
    </section>
